// credit: https://github.com/agari-industries/agari/blob/main/web/src/lib/agari.ts
...
let wasmModule: typeof import("./agari_wasm") | null = null;
...
export async function initAgari(): Promise<void> {
  ...
  if (!initPromise) {
    initPromise = (async () => {
      const wasm = await import("./agari_wasm");
      await wasm.default();
      wasmModule = wasm;
    })();
  }
